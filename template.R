...
###############################################################################
# TEMPLATE HEADER FOR NEW SCRIPTS (reference only)
# Script:    <file_name>.R
# Project:   <project or puzzle name>
# Author:    GRID
# Created:   <MM-DD-YYYY>
# Purpose:   <short description: what question are we answering?>
# Link:      <link, if applicable>
# Run as:    
# Usage (CLI):
#   Rscript <file_name>.R path/to/input.txt
#
# Usage (interactive):
#   source("path/to/<file_name>.R")
...
run_checks <- function() {
  # Example AoC pattern:
  # example_raw  <- read_lines(here("2025", "DayX", "example.txt"))
...
if (sys.nframe() == 0L) {
  ...
  default_input <- "path/to/input.txt"
