...
# Purpose:   Solve AoC 2025 Day 11 – <puzzle title>
# Link:      https://adventofcode.com/2025/day/11
#
# Usage (CLI, from repo root):
#   Rscript 2025/Day11/day11.R 2025/Day11/input.txt
#
# Usage (interactive, from repo root):
#   source("2025/Day11/day11.R")
#   main("2025/Day11/input.txt")
###############################################################################
...
main <- function(
    input_path = here("2025", "Day11", "input.txt"),
    verbose = TRUE
) {
...
if (sys.nframe() == 0L) {
  ...
  default_input <- here("2025", "Day11", "input.txt")
